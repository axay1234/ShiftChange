            ...
            <Aux>
                <Row>
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Abnormal Process Issues or Significant Alarm Conditions</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-green f-30 m-r-5"/>%2</h3>
                                    </div>
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Process Equipment Changes</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-down text-c-red f-30 m-r-5"/>1%</h3>
                                    </div>
                    ...
                    <Col xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Critical Issues in Nearby Unit(s)</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-green f-30 m-r-5"/>0.5%</h3>
                                    </div>
                    ...
                    <Col md={6} xl={8}>
                        <Card className='Recent-Users'>
                            <Card.Header>
                                <Card.Title as='h5'>Recent Shift Reports</Card.Title>
                            </Card.Header>
                            <Card.Body className='px-0 py-2'>
                                <Table responsive hover>
                                    ...
                                    <tr className="unread">
                                        ...
                                        <td>
                                            <h6 className="mb-1">Mike BeCraft</h6>
                                            <p className="m-0">Report: ATS-ALKY_TECHNICIAN_1-20190717-NIGHT...</p>
                                        </td>
                                        <td>
                                            <h6 className="text-muted"><i className="fa fa-circle text-c-green f-10 m-r-15"/>12 Dec 12:56</h6>
                                        </td>
                                    ...
                                    <tr className="unread">
                                        <td><img className="rounded-circle" style={{width: '40px'}} src={avatar2} alt="activity-user"/></td>
                                        <td>
                                            <h6 className="mb-1">Mike Sims</h6>
                                            <p className="m-0">Report: ATS-ALKY_TECHNICIAN_1-20190717-NIGHT…</p>
                                        </td>
                                        <td>
                                            <h6 className="text-muted"><i className="fa fa-circle text-c-red f-10 m-r-15"/>11 Dec 10:35</h6>
                                        </td>
                                        <td><a href={DEMO.BLANK_LINK} className="label theme-bg2 text-white f-12">Reject</a><a href={DEMO.BLANK_LINK} className="label theme-bg text-white f-12">Approve</a></td>
                                    </tr>
                                    <tr className="unread">
                                        ...
                                        <td>
                                            <h6 className="mb-1">Joseph Hutcinson</h6>
                                            <p className="m-0">Report: ATS-ALKY_TECHNICIAN_1-20190717-NIGHT…</p>
                                        </td>
                                        <td>
                                            <h6 className="text-muted"><i className="fa fa-circle text-c-green f-10 m-r-15"/>11 Dec 17:38</h6>
                                        </td>
                                        <td><a href={DEMO.BLANK_LINK} className="label theme-bg2 text-white f-12">Reject</a><a href={DEMO.BLANK_LINK} className="label theme-bg text-white f-12">Approve</a></td>
                                    </tr>
                                    <tr className="unread">
                    ...
                    <Col md={6} xl={4}>
                        <Card className='card-event'>
                            <Card.Body>
                                ...
                                <h2 className="mt-2 f-w-300">BigSpring<sub className="text-muted f-14">turnaround</sub></h2>
                                <h6 className="text-muted mt-3 mb-0">For updates click here </h6>
